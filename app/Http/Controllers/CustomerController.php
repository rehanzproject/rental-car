...
class CustomerController extends Controller
{
    public function list()
    {
        return datatables()
            ...
            ->editColumn('images', function ($user) {
                if ($user->images) {
                    return ' <img src="' . asset('storage/images/' . $user->images) . '" class="img-circle elevation-2" alt="' . $user->images . '" style="object-fit: cover; width: 60px; height: 60px; border: 3px solid white;"> ';
                } else {
                    return ' <img src="' . asset('img/user-profile-default.jpg') . '" class="img-circle elevation-2" alt="' . $user->images . '" style="object-fit: cover; width: 60px; height: 60px; border: 3px solid white;"> ';
                }
            })
            ->addIndexColumn()
    ...
    public function update(Request $request, User $user)
    {
        ...
        return redirect('/dashboard/customer')->with('success', 'Customer Edited Successfully');
    }
